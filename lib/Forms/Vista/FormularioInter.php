                            ...
                            if ($value['tipo_campo'] == 'TEXTO') {
                                ...
                                <?php if ($value['campo_identi'] == 'id_javeriana') {
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <td><input type="hidden"  name="<?php echo $value['campo_identi'] ?>" id="<?php echo $value['campo_identi'] ?>" value="<?php echo $usuario['id_javeriana'] ?>"><h4><span class="label label-info"><?php echo $usuario['id_javeriana'] ?></span></h4></td>
                                    <?php } ?>
